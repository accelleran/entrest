...
When you mark a schema as a subentity using [`WithSubentity(true)`](/entrest/openapi-specs/annotation-reference/#withsubentity):
...
| Behavior | [`WithSkip(true)`](/entrest/openapi-specs/annotation-reference/#withskip) | [`WithSubentity(true)`](/entrest/openapi-specs/annotation-reference/#withsubentity) | [`WithHandler(false)`](/entrest/openapi-specs/annotation-reference/#withhandler) |
|----------|------------------|----------------------|---------------------|
...
*_Edge endpoints are enabled by default. Use [`WithEdgeEndpoint(false)`](/entrest/openapi-specs/annotation-reference/#withedgeendpoint) to disable them._
