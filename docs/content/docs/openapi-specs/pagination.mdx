...
- Turning pagination on/off.
  - **Globally**: with the [`DisablePagination`](/entrest/openapi-specs/configuration/#disablepagination) config option.
...
- Adjusting the default, minimum and maximum number of results per page.
  - **Globally**: with the [`ItemsPerPage`](/entrest/openapi-specs/configuration/#itemsperpage), [`MinItemsPerPage`](/entrest/openapi-specs/configuration/#minitemsperpage), and [`MaxItemsPerPage`](/entrest/openapi-specs/configuration/#maxitemsperpage) config options.
