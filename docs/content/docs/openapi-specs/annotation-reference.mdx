...
| [WithIncludeOperations](#withincludeoperations) | <Usage types={["schema", "edge"]} /> | Explicitly sets which operations are enabled, overriding Config.DefaultOperations entirely. |
| [WithExcludeOperations](#withexcludeoperations) | <Usage types={["schema", "edge"]} /> | Excludes the specified operations from Config.DefaultOperations. |
...
[ [pkg.go.dev](https://pkg.go.dev/github.com/lrstanley/entrest#WithSubentity) | usage: <Usage types={["schema"]} /> ]
...
> Config.DefaultOperations entirely.
