...
The [`SpecFromPath`](/entrest/openapi-specs/configuration/#specfrompath) config option allows
...
[here](https://github.com/accelleran/entrest/blob/master/_examples/kitchensink/internal/database/ent/rest/openapi.json).
...
The [`Spec`](/entrest/openapi-specs/configuration/#spec) config option allows you to provide
...
The [`PreGenerateHook`](/entrest/openapi-specs/configuration/#pregeneratehook) and [`PostGenerateHook`](/entrest/openapi-specs/configuration/#postgeneratehook) config options are
